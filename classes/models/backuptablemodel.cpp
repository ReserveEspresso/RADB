...
{
    if (size.contains(QRegularExpression("^\\d+.\\d+ .iB$")) || size.contains(QRegularExpression("^\\d+ B$")))
    {
        return size;
    }
    else
...
bool BackupSortModel::lessThan(const QModelIndex &left, const QModelIndex &right) const
{
    ...
    if (leftName.contains(QRegularExpression("B$")) && rightName.contains(QRegularExpression("B$")))
    {
        ...
        if (leftName.contains(QRegularExpression("^\\d+ B$")))
        {
            if (rightName.contains(QRegularExpression("^\\d+ B$")))
                return wynik;
            if (rightName.contains(QRegularExpression("^\\d+.\\d+ KiB$")))
                return true;
            if (rightName.contains(QRegularExpression("^\\d+.\\d+ MiB$")))
                return true;
            if (rightName.contains(QRegularExpression("^\\d+.\\d+ GiB$")))
                return true;
        }
        if (leftName.contains(QRegularExpression("^\\d+.\\d+ KiB$")))
        {
            if (rightName.contains(QRegularExpression("^\\d+ B$")))
                return false;
            if (rightName.contains(QRegularExpression("^\\d+.\\d+ KiB$")))
        ...
        if (leftName.contains(QRegularExpression("^\\d+.\\d+ MiB$")))
        {
            if (rightName.contains(QRegularExpression("^\\d+ B$")))
                return false;
            if (rightName.contains(QRegularExpression("^\\d+.\\d+ KiB$")))
        ...
        if (leftName.contains(QRegularExpression("^\\d+.\\d+ GiB$")))
        {
            if (rightName.contains(QRegularExpression("^\\d+ B$")))
                return false;
            if (rightName.contains(QRegularExpression("^\\d+.\\d+ KiB$")))
